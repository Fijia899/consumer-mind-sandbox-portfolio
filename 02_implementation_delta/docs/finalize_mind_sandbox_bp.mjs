...
const candidatePath = path.join(workspaceDir, ".codex-build-mind-sandbox-bp", "consumer-mind-sandbox-bp-draft.pptx");
const finalPath = path.join(workspaceDir, "outputs", "消费者心智沙盘_BP.pptx");
const stagingDir = path.join(workspaceDir, ".codex-finalizer-mind-sandbox-bp");
...
const result = await finalizePresentation({
  ...
  receiptPath: path.join(stagingDir, "消费者心智沙盘_BP.validation.json"),
});
